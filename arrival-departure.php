...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.php">Arrival/Departure</a>
	  ...
	  <section class="hero-wrap hero-wrap-2" style="background-image: url('images/resort/73826039.jpg');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section">
      <div class="container">
        ...
        <h4 class="mb-3 mt-5"><?php content("health-arival-head1");?></h4>
            ...
            <p>
              <img src="images/resort/img_16.jpg" alt="" class="img-fluid">
            </p>
		</div> <!-- .col-md-8 -->
		</div>
      </div>
