      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            <h2 class="mb-3"><?php content("price-head");?></h2>
			    <h4 class="mb-3"><?php content("price-head1");?></h4>
            <p><?php content("price-head1-msg1");?></p>
            <p><?php content("price-head1-msg2");?></p>
            <p><?php content("price-head1-msg3");?></p>
            <p><?php content("price-head1-msg4");?></p>
			    <h4 class="mb-3"><?php content("price-head2");?></h4>
            <p><?php content("price-head2-msg1");?></p>
            <p><?php content("price-head2-msg2");?></p>
            <p><?php content("price-head2-msg3");?></p>
            <p><?php content("price-head2-msg4");?></p>
          <h4 class="mb-3"><?php content("price-head3");?></h4>
            <p><?php content("price-head3-msg1");?></p>
            <p><?php content("price-head3-msg2");?></p>
            <p><?php content("price-head3-msg3");?></p>
            <p><?php content("price-head3-msg4");?></p>
            <p><?php content("price-head3-msg5");?></p>
            <p><?php content("price-head3-msg6");?></p>
            <p><?php content("price-head3-msg7");?></p>
		    </div> <!-- .col-md-8 -->
      </div>
    </section> <!-- .section -->
