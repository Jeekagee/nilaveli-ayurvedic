	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
	          ...
	          <li class="nav-item"><a href="overview-treatments.php" class="nav-link"><span>Overview Treatements</span></a></li>
	          <li class="nav-item"><a href="treatments.php" class="nav-link"><span>Treatments</span></a></li>
	          <li class="nav-item"><a href="treatments-process.php" class="nav-link"><span>Treatements Process</span></a></li>
	          <li class="nav-item"><a href="diagnosis.php" class="nav-link"><span>Diagnosis</span></a></li>
			  <li class="nav-item"><a href="herbal-medicine.php" class="nav-link"><span>Herbal Medicine</span></a></li>
			  <li class="nav-item"><a href="nutrition.php" class="nav-link"><span>Nutrition</span></a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
	  
	  <section class="hero-wrap hero-wrap-2" style="background-image: url('images/img_3.jpg');" data-stellar-background-ratio="0.5">
