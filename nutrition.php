...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.php">Nutrition</a>
	  ...
	  <section class="hero-wrap hero-wrap-2" style="background-image: url('images/img_21.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-4">
            <h1 class="mb-3 bread">Nutrition</h1>
             <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Nutrition<i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 ftco-animate">
            <h2 class="mb-3">Eating, drinking - and a look into the kitchen</h2>
              <img src="images/img_34.jpg" alt="" class="img-fluid">
            </p>
			<p>According to the respective health needs, the treatments are accompanied by a personalized vegetarian diet. This of course is based on Ayurvedic philosophy and has a purifying effect on the organism and invigorates its resistance. The guests should consciously enjoy with full board and eat energy and vitamin rich foods to purify effectively. This is the starting point for more health and physical harmony. A careful selection of spices and the artful combination of the six flavors sweet, sour, salty, hot, bitter and acetous, support the foods healing properties. The food is healthy and gently prepared with local vegetables, fresh herbs and vitamin-rich fruits. Special diets for food intolerances are possible after consultation.</p>
            <p>
